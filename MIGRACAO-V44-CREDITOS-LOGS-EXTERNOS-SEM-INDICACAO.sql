-- =============================================================
-- LocaCheck V44 (arquivo corrigido na V45)
...
-- -------------------------------------------------------------
-- CORREÇÃO V45: chave estrangeira segura para o usuário do Supabase Auth
-- -------------------------------------------------------------
...
select column_default as credits_default_v44
