      ...
      <div className="recordModal rentalSiteEditorV67 rentalSiteEditorV68">
        ...
        {loading ? <div className="rentalSiteLoadingV63"><RefreshCw size={22} className="rentalSiteSpinV63"/> Consultando seu benefício...</div> : !active ? (
          ...
          <>
            ...
            <aside className="rentalLivePreviewV68">
              <div className="rentalLivePreviewHeaderV68"><div><span>PRÉVIA EM TEMPO REAL</span><strong>Veja o site enquanto edita</strong></div><span className="rentalLivePreviewDotV68">● AO VIVO</span></div>
